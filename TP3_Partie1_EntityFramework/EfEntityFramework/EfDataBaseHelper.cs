...
namespace TP3_Partie1_EntityFramework.EfEntityFramework
{
    class EfDataBaseHelper
    {
        ...
        private void AddData()
        {
           ...
           var tuto2 = new TutoringSession() { DateSession = new DateTime(2015, 03, 24), TimeSession = 10, LenghtSession = 1, Helped = stu5, Tutor = t1 };
           _tutoringSessionRepository.Add(tuto2);
           var tuto3 = new TutoringSession() { DateSession = new DateTime(2015, 03, 25), TimeSession = 13, LenghtSession = 1, Helped = stu2, Tutor = t4 };
           _tutoringSessionRepository.Add(tuto3);
           var tuto4 = new TutoringSession() { DateSession = new DateTime(2015, 04, 01), TimeSession = 12, LenghtSession = 2, Helped = stu1, Tutor = t5 };
           _tutoringSessionRepository.Add(tuto4);
           var tuto5 = new TutoringSession() { DateSession = new DateTime(2015, 04, 01), TimeSession = 13, LenghtSession = 1, Helped = stu2, Tutor = t3 };
           _tutoringSessionRepository.Add(tuto5);
           var tuto6 = new TutoringSession() { DateSession = new DateTime(2015, 04, 06), TimeSession = 16, LenghtSession = 1, Helped = stu1, Tutor = t4 };
           _tutoringSessionRepository.Add(tuto6);
           var tuto7 = new TutoringSession() { DateSession = new DateTime(2015, 04, 08), TimeSession = 10, LenghtSession = 1, Helped = stu7, Tutor = t4 };
           _tutoringSessionRepository.Add(tuto7);
           var tuto8 = new TutoringSession() { DateSession = new DateTime(2015, 04, 10), TimeSession = 10, LenghtSession = 2, Helped = stu1, Tutor = t4 };
           _tutoringSessionRepository.Add(tuto8);
           var tuto9 = new TutoringSession() { DateSession = new DateTime(2015, 04, 29), TimeSession = 12, LenghtSession = 1, Helped = stu9, Tutor = t5 };
           _tutoringSessionRepository.Add(tuto9);
           var tuto10 = new TutoringSession() { DateSession = new DateTime(2015, 05, 25), TimeSession = 13, LenghtSession = 1, Helped = stu10, Tutor = t7 };
           _tutoringSessionRepository.Add(tuto10);
           var tuto11 = new TutoringSession() { DateSession = new DateTime(2015, 05, 27), TimeSession = 12, LenghtSession = 2, Helped = stu10, Tutor = t5 };
           _tutoringSessionRepository.Add(tuto11);
           var tuto12 = new TutoringSession() { DateSession = new DateTime(2015, 05, 27), TimeSession = 13, LenghtSession = 1, Helped = stu2, Tutor = t3 };
           _tutoringSessionRepository.Add(tuto12);
           var tuto13 = new TutoringSession() { DateSession = new DateTime(2015, 06, 01), TimeSession = 9, LenghtSession = 1, Helped = stu7, Tutor = t7 };
           _tutoringSessionRepository.Add(tuto13);
           var tuto14 = new TutoringSession() { DateSession = new DateTime(2015, 06, 02), TimeSession = 9, LenghtSession = 1, Helped = stu11, Tutor = t7 };
           _tutoringSessionRepository.Add(tuto14);
           var tuto15 = new TutoringSession() { DateSession = new DateTime(2015, 06, 02), TimeSession = 11, LenghtSession = 1, Helped = stu2, Tutor = t7 };
           _tutoringSessionRepository.Add(tuto15);
           var tuto16 = new TutoringSession() { DateSession = new DateTime(2015, 06, 02), TimeSession = 13, LenghtSession = 1, Helped = stu5, Tutor = t1 };
           _tutoringSessionRepository.Add(tuto16);
           var tuto17 = new TutoringSession() { DateSession = new DateTime(2015, 06, 02), TimeSession = 15, LenghtSession = 1, Helped = stu9, Tutor = t4 };
           _tutoringSessionRepository.Add(tuto17);
           var tuto18 = new TutoringSession() { DateSession = new DateTime(2015, 06, 03), TimeSession = 13, LenghtSession = 2, Helped = stu7, Tutor = t3 };
